...
namespace UniTwitchClient.Tests.EventSub.Api
{
    public class EventSubSubscriptionDataTest
    {
        ...
        public void GetEnabledSubscriptionsTest() 
        {
            ...
            Assert.AreEqual(3, enabledSubs.Subscriptions.Count);
        ...
        [Test]
        public void GetNonEnabledSubscriptionsTest()
        {
            List<EventSubSubscription> eventSubSubscriptions = new List<EventSubSubscription>();
            ...
            var nonEnabledSubs = eventSubSubscriptionData.GetNonEnabledSubscriptions();

            Assert.IsNotNull(nonEnabledSubs);
            Assert.AreEqual(1, nonEnabledSubs.Subscriptions.Count);
            Assert.AreEqual("abc3", nonEnabledSubs.Subscriptions[0].Id);
        }
    }
}